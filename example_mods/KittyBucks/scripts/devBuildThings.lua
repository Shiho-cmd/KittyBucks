...
function onUpdate(elapsed)
    ...
    elseif keyboardPressed("D") and getModSetting("butt") and getModSetting("livre") then
        camX = camX + 10
        triggerEvent("Camera Follow Pos", camX, camY)
    elseif keyboardPressed("RIGHT") and getModSetting("butt") and keyboardPressed("SHIFT") then
        setSongPosition(getSongPosition() + 500)
    elseif keyboardPressed("LEFT") and getModSetting("butt") and keyboardPressed("SHIFT") then
        setSongPosition(getSongPosition() - 500)
    elseif keyboardJustPressed("RIGHT") and getModSetting("butt") and not keyboardPressed("SHIFT") then
        setSongPosition(getSongPosition() + 5000)
    elseif keyboardJustPressed("LEFT") and getModSetting("butt") and not keyboardPressed("SHIFT") then
        setSongPosition(getSongPosition() - 5000)
