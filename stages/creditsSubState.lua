...
function onUpdate(elapsed)
    ...
    elseif slctPos > 2 and pos == 4 or slctPos > 2 and pos == 2 then
        slctPos = 0
    elseif slctPos < 0 and pos == 4 or slctPos < 0 and pos == 2 or slctPos > 1 and pos == 2 or pos == 1 or pos == 0 then
        slctPos = 1
    end
