...
offsets = {
	{left, parsed.animations[4].offsets[1], parsed.animations[4].offsets[2]},
...
leftXml = parsed.animations[4].name;
...
function onCreate()
	...
	addAnimationByPrefix(tagForChar, 'singLEFT', leftXml, parsed.animations[4].fps, false);
	...
	setProperty(tagForChar..".alpha", 0.00001)
	createAnimCases()
	extraAnimCases()
end
