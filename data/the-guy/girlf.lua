...
offsets = {
	{left, parsed.animations[3].offsets[1], parsed.animations[3].offsets[2]},
	{down, parsed.animations[4].offsets[1], parsed.animations[4].offsets[2]},
	{up, parsed.animations[6].offsets[1], parsed.animations[6].offsets[2]},
	{right, parsed.animations[5].offsets[1], parsed.animations[5].offsets[2]},
	{idle, 0, 0}
}
...
leftXml = parsed.animations[3].name;
downXml = parsed.animations[4].name;
upXml = parsed.animations[6].name;
rightXml = parsed.animations[5].name;
idleXml = nil;--you can leave this blank if you're using danceLeft and danceRight

danceLeftXml = parsed.animations[1].name; --for danceLeft and danceRight if you're using those
danceRightXml = parsed.animations[2].name;
...
function onCreate()
	...
	addAnimationByPrefix(tagForChar, 'singLEFT', leftXml, parsed.animations[3].fps, false);
	addAnimationByPrefix(tagForChar, 'singDOWN', downXml, parsed.animations[4].fps, false);
	addAnimationByPrefix(tagForChar, 'singUP', upXml, parsed.animations[6].fps, false);
	addAnimationByPrefix(tagForChar, 'singRIGHT', rightXml, parsed.animations[5].fps, false);
